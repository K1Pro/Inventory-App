...
<table class="table table-striped">
  <tr>
    ...
    <!-- Modify Table Header -->
    <th style="vertical-align:middle" width="75px">Modify</th>
    <!-- Email Table Header -->
...
<?php
    ...
    echo '<td class="tdCenter">';
        echo '<a href="./index.php?page=Manage-'.ucfirst($chosenDB).'&id='.$dbValuesOne['invoices_id'].'&pin='.$dbValuesOne['bill_zip'].'';
        if ($chosenDB == "invoices"){ echo '">';} else {echo '&action=estimate">';}
