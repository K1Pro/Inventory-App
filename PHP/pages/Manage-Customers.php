        ...
        <!-- action='./index.php?page=Modified-Customers&id= -->
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="firstName" id="firstName" placeholder="" value="<?php print_r($customerValues['first_name']);?>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="address" id="address" placeholder="1234 Main St" value="<?php print_r($customerValues['address']);?>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" name="city" id="city" value="<?php print_r($customerValues['city']);?>" placeholder="" required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-3">
              ...
              <input type="text" class="form-control" name="zip" id="zip" placeholder="" value="<?php print_r($customerValues['zip']);?>" required>
              <div class="invalid-feedback">
                Zip code required.
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="phone" id="phone" placeholder="###-###-####" value="<?php print_r($customerValues['phone']);?>" required>
              <div class="invalid-feedback">
                Phone is required.
              </div>
            </div>
            ...
            <div class="col-12">
              ...
              <input type="email" class="form-control" name="email" id="email" placeholder="you@example.com" value="<?php print_r($customerValues['email']);?>" required>
              <div class="invalid-feedback">
